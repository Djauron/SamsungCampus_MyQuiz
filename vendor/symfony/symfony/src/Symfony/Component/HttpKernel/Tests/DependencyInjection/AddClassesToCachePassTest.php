...
class AddClassesToCachePassTest extends TestCase
{
    public function testExpandClasses()
    {
        ...
        $this->assertSame(
            'Acme\\FooBundle\\Controller\\QuizController',
            $expand(array('**Bundle\\Controller\\'), array('\\Acme\\FooBundle\\Controller\\QuizController'))[0]
        );

        $this->assertSame(
            'FooBundle\\Controller\\QuizController',
            $expand(array('**Bundle\\Controller\\'), array('\\FooBundle\\Controller\\QuizController'))[0]
        );

        $this->assertSame(
            'Acme\\FooBundle\\Controller\\Bar\\QuizController',
            $expand(array('**Bundle\\Controller\\'), array('\\Acme\\FooBundle\\Controller\\Bar\\QuizController'))[0]
        );

        $this->assertSame(
            'Bundle\\Controller\\Bar\\QuizController',
            $expand(array('**Bundle\\Controller\\'), array('\\Bundle\\Controller\\Bar\\QuizController'))[0]
        );

        $this->assertSame(
            'Acme\\Bundle\\Controller\\Bar\\QuizController',
            $expand(array('**Bundle\\Controller\\'), array('\\Acme\\Bundle\\Controller\\Bar\\QuizController'))[0]
        );
